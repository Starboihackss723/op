...
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "5463205082").split())
)
...
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/Best_FriendsFor_Ever")
...
SPOTIFY_CLIENT_ID = getenv("SPOTIFY_CLIENT_ID", "false")
SPOTIFY_CLIENT_SECRET = getenv("SPOTIFY_CLIENT_SECRET", "false")
...
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/1e1d6269dbc443b0e5bd0.jpg")

PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "https://telegra.ph/file/2f6c4b784ee0977777e93.jpg",
)
